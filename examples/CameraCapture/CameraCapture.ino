/**
 * @file      CameraCapture.ino
 * @author    piaoxuebingfeng (526656549@qq.com)
 * @license   MIT
 * @copyright Copyright (c) 2024
 * @date      2024-11-28
 * @note      Sketch Adaptation T-Display-S3-Pro Camera Capture a picture and Save to SD Card , see README
